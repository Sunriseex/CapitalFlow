...
Before starting the API, make sure `configs/.env` exists and contains a strong `JWT_SECRET`. If you run the bearer-token fallback mode, also set a strong `API_AUTH_TOKEN`.
