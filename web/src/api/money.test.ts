...
describe("parseMoneyToMinorResult", () => {
  it.each([
    ...
    ["valid KWD decimal", "12.345", { currency: "KWD" }, { ok: true, value: "12.345" }],
    ["valid CLF decimal", "12.3456", { currency: "CLF" }, { ok: true, value: "12.3456" }],
    ["valid USDT decimal", "12.345678", { currency: "USDT" }, { ok: true, value: "12.345678" }],
    ...
    ["too many KWD decimals", "1.2345", { currency: "KWD" }, { ok: false, error: "Amount must be a number with up to 3 decimal places" }],
    ["too many USDT decimals", "1.2345678", { currency: "USDT" }, { ok: false, error: "Amount must be a number with up to 6 decimal places" }],
    ["JPY decimal", "1.2", { currency: "JPY" }, { ok: false, error: "Amount must be a number with up to 0 decimal places" }],
