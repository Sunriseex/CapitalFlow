...
* [ ] Затем ввести универсальные счета и транзакции.
* [ ] После этого добавить API и WebUI.
...
# v0.2 — Domain Core: Accounts, Transactions, Interest Rules

## Цель

Перейти от модели “вклад как отдельная сущность” к универсальной финансовой модели: счет + операции + правила процентов.
...
Добавить backend API для будущего WebUI.
...
# v1.0 — Personal Finance Tracker Release
...
2. [ ] Добавить этот TODO в проект.
3. [ ] Добавить `README.md` для `scripts/finance-manager`.
4. [ ] Добавить `docs/architecture.md`.
5. [x] Добавить тесты на текущий calculator.
6. [ ] Перевести денежные значения на `int64`.
7. [ ] Перевести ставки на basis points.
8. [ ] Добавить `Account` и `Transaction`.
9. [ ] Добавить PostgreSQL и миграции.
10. [ ] Поднять HTTP API.
11. [ ] Сделать WebUI MVP.
12. [ ] Добавить allocation calculator.
13. [ ] Добавить smart budget calculator.
14. [ ] Добавить LLM foundation.
...
* Главная уникальность проекта: учет вкладов, капитализации, умного распределения дохода и self-hosted LLM-аналитики.
